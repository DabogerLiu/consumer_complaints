...
complains = csv_dict_list('  ../insight_testsuite/tests/test_2/input/consumer_complaints.csv')
...
with open(' ../insight_testsuite/tests/test_2/output/report.csv', 'w', newline='') as csvfile:
